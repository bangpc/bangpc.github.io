jQuery && function(e) {
    function t(i) {
        var t = i.parent();
        i.removeData("minicolors-initialized").removeData("minicolors-settings").removeProp("size").removeProp("maxlength").removeClass("minicolors-input"), t.before(i).remove()
    }
    ...
    function a() {
        e(".minicolors-input").each(function() {
            ...
            t.inline || o.find(".minicolors-panel").fadeOut(t.hideSpeed, function() {
                o.hasClass("minicolors-focus") && t.hide && t.hide.call(i), o.removeClass("minicolors-focus")
            })
        })
    }
    ...
    function n(i, t, o) {
        ...
        t.originalEvent.changedTouches && (c = t.originalEvent.changedTouches[0].pageX - e, l = t.originalEvent.changedTouches[0].pageY - r), c < 0 && (c = 0), l < 0 && (l = 0), c > i.width() && (c = i.width()), l > i.height() && (l = i.height()), i.parent().is(".minicolors-slider-wheel") && a.parent().is(".minicolors-grid") && (e = 75 - c, t = 75 - l, r = Math.sqrt(e * e + t * t), (e = Math.atan2(t, e)) < 0 && (e += 2 * Math.PI), 75 < r && (c = 75 - 75 * Math.cos(e), l = 75 - 75 * Math.sin(e)), c = Math.round(c), l = Math.round(l)), i.is(".minicolors-grid") ? a.stop(!0).animate({
            top: l + "px",
            left: c + "px"
    ...
    function h(i, t) {
        ...
        var s, n, a, e = i.val(),
            ...
            c = i.parent(),
            l = i.data("minicolors-settings"),
            h = (c.find(".minicolors-panel"), c.find(".minicolors-swatch")),
            d = c.find(".minicolors-grid"),
            p = c.find(".minicolors-slider"),
            u = c.find(".minicolors-opacity-slider"),
            g = d.find("[class$=-picker]"),
            m = p.find("[class$=-picker]"),
            f = u.find("[class$=-picker]"),
            b = o(g, d),
            v = o(m, p),
            f = o(f, u);
        if (t.is(".minicolors-grid, .minicolors-slider")) {
            switch (l.control) {
                case "wheel":
                    s = d.width() / 2 - b.x, a = d.height() / 2 - b.y, n = Math.sqrt(s * s + a * a), (a = Math.atan2(a, s)) < 0 && (a += 2 * Math.PI), 75 < n && (n = 75, b.x = 69 - 75 * Math.cos(a), b.y = 69 - 75 * Math.sin(a)), s = C(n / .75, 0, 100), e = x({
        ...
        t.is(".minicolors-opacity-slider") && (r = l.opacity ? parseFloat(1 - f.y / u.height()).toFixed(2) : 1, l.opacity && i.attr("data-opacity", r)), h.find("SPAN").css({
            backgroundColor: e,
            opacity: r
        }), y(i, e, r)
    }
    ...
    function r(i, t, o) {
        var s, n, a, e, r, c = i.parent(),
            l = i.data("minicolors-settings"),
            h = c.find(".minicolors-swatch"),
            d = c.find(".minicolors-grid"),
            p = c.find(".minicolors-slider"),
            u = c.find(".minicolors-opacity-slider"),
            g = d.find("[class$=-picker]"),
            ...
            v = function(i) {
                i = function(i) {
                    var t = {
                        ...
                        o = s - o;
                    t.b = s, t.s = 0 !== s ? 255 * o / s : 0, 0 !== t.s ? i.r === s ? t.h = (i.g - i.b) / o : i.g === s ? t.h = 2 + (i.b - i.r) / o : t.h = 4 + (i.r - i.g) / o : t.h = -1;
        ...
        switch (t || i.val(b), l.opacity && (s = "" === i.attr("data-opacity") ? 1 : C(parseFloat(i.attr("data-opacity")).toFixed(2), 0, 1), isNaN(s) && (s = 1), i.attr("data-opacity", s), h.find("SPAN").css("opacity", s), a = C(u.height() - u.height() * s, 0, u.height()), f.css("top", a + "px")), h.find("SPAN").css("backgroundColor", b), l.control) {
            case "wheel":
                e = C(Math.ceil(.75 * v.s), 0, d.height() / 2), r = v.h * Math.PI / 180, n = C(75 - Math.cos(r) * e, 0, d.width()), a = C(75 - Math.sin(r) * e, 0, d.height()), g.css({
                    top: a + "px",
                    left: n + "px"
                }), a = 150 - v.b / (100 / d.height()), "" === b && (a = 0), m.css("top", a + "px"), p.css("backgroundColor", x({
                    h: v.h,
                    s: v.s,
                    b: 100
                }));
                break;
            case "saturation":
                n = C(5 * v.h / 12, 0, 150), a = C(d.height() - Math.ceil(v.b / (100 / d.height())), 0, d.height()), g.css({
                    top: a + "px",
                    left: n + "px"
                }), a = C(p.height() - v.s * (p.height() / 100), 0, p.height()), m.css("top", a + "px"), p.css("backgroundColor", x({
                    h: v.h,
                    s: 100,
                    b: v.b
                ...
                break;
            case "brightness":
                n = C(5 * v.h / 12, 0, 150), a = C(d.height() - Math.ceil(v.s / (100 / d.height())), 0, d.height()), g.css({
                    top: a + "px",
                    left: n + "px"
                }), a = C(p.height() - v.b * (p.height() / 100), 0, p.height()), m.css("top", a + "px"), p.css("backgroundColor", x({
                    h: v.h,
                    s: v.s,
                    b: 100
                ...
                break;
            default:
                n = C(Math.ceil(v.s / (100 / d.width())), 0, d.width()), a = C(d.height() - Math.ceil(v.b / (100 / d.height())), 0, d.height()), g.css({
                    top: a + "px",
                    left: n + "px"
                }), a = C(p.height() - v.h / (360 / p.height()), 0, p.height()), m.css("top", a + "px"), d.css("backgroundColor", x({
                    h: v.h,
                    s: 100,
                    b: 100
                }))
    ...
    function y(i, t, o) {
        ...
        t + o !== i.data("minicolors-lastChange") && (i.data("minicolors-lastChange", t + o), s.change && (s.changeDelay ? (clearTimeout(i.data("minicolors-changeTimeout")), i.data("minicolors-changeTimeout", setTimeout(function() {
            s.change.call(i, t, o)
    ...
    function M(i, t) {
        return 3 !== (i = i.replace(/[^A-F0-9]/gi, "")).length && 6 !== i.length ? "" : (3 === i.length && t && (i = i[0] + i[0] + i[1] + i[1] + i[2] + i[2]), "#" + i)
    }
    ...
    function x(i) {
        return t = i, s = {}, n = Math.round(t.h), a = Math.round(255 * t.s / 100), i = Math.round(255 * t.b / 100), 0 === a ? s.r = s.g = s.b = i : (i = n % 60 * ((t = i) - (a = (255 - a) * i / 255)) / 60, 360 === n && (n = 0), n < 60 ? (s.r = t, s.b = a, s.g = a + i) : n < 120 ? (s.g = t, s.b = a, s.r = t - i) : n < 180 ? (s.g = t, s.r = a, s.b = a + i) : n < 240 ? (s.b = t, s.r = a, s.g = t - i) : n < 300 ? (s.b = t, s.g = a, s.r = a + i) : n < 360 ? (s.r = t, s.g = a, s.b = t - i) : (s.r = 0, s.g = 0, s.b = 0)), s = {
            r: Math.round(s.r),
            g: Math.round(s.g),
            b: Math.round(s.b)
        }, o = [s.r.toString(16), s.g.toString(16), s.b.toString(16)], e.each(o, function(i, t) {
            1 === t.length && (o[i] = "0" + t)
        }), "#" + o.join("");
        var o, t, s, n, a
    }
    ...
    e.minicolors = {
            ...
            switch (i) {
                ...
                case "settings":
                    return void 0 === n ? e(this).data("minicolors-settings") : (e(this).each(function() {
                        ...
                        t(e(this)), e(this).minicolors(e.extend(!0, i, n))
                    }), e(this));
                case "show":
                    return s(e(this).eq(0)), e(this);
                case "value":
                ...
                case "create":
                default:
                    return "create" !== i && (n = i), e(this).each(function() {
                        var i, t, o, s;
                        i = e(this), t = n, o = e('<span class="minicolors" />'), s = e.minicolors.defaultSettings, i.data("minicolors-initialized") || (t = e.extend(!0, {}, s, t), o.addClass("minicolors-theme-" + t.theme).addClass("minicolors-swatch-position-" + t.swatchPosition).toggleClass("minicolors-swatch-left", "left" === t.swatchPosition).toggleClass("minicolors-with-opacity", t.opacity), void 0 !== t.position && e.each(t.position.split(" "), function() {
                            o.addClass("minicolors-position-" + this)
                        }), i.addClass("minicolors-input").data("minicolors-initialized", !0).data("minicolors-settings", t).prop("size", 7).prop("maxlength", 7).wrap(o).after('<span class="minicolors-panel minicolors-slider-' + t.control + '"><span class="minicolors-slider"><span class="minicolors-picker"></span></span><span class="minicolors-opacity-slider"><span class="minicolors-picker"></span></span><span class="minicolors-grid"><span class="minicolors-grid-inner"></span><span class="minicolors-picker"><span></span></span></span></span>'), i.parent().find(".minicolors-panel").on("selectstart", function() {
                            return !1
                        }).end(), "left" === t.swatchPosition ? i.before('<span class="minicolors-swatch"><span></span></span>') : i.after('<span class="minicolors-swatch"><span></span></span>'), t.textfield || i.addClass("minicolors-hidden"), t.inline && i.parent().addClass("minicolors-inline"), r(i, !1, !0))
                    }), e(this)
            }
        }
        ...
        var t = e(this);
        i.preventDefault(), e(document).data("minicolors-target", t), n(t, i, !0)
        ...
        t.data("minicolors-initialized") && (t.val(M(t.val(), !0)), "" === t.val() && t.val(M(o.defaultValue, !0)), t.val(w(t.val(), o.letterCase)))
